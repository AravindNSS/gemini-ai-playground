...
MEMORY = [
    "User already knows basic AI concepts and in last session we discussed machine learning.",
    "User is confused about the difference between AI, ML, and DL.",
]
